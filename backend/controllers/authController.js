...
const updateUserProfile = async (req, res) => {
    try {
        ...
        // role is intentionally not settable here: it may only be chosen at registration,
        // so a user can never escalate their own privilege via profile self-service.
